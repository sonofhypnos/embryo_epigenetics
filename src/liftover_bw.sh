...
wiggletools write_bg - "$WIGFILE" |
    ...
    liftOver temp.bedGraph "$data_dir/hg19ToHg38.over.chain" temp_lifted.bedGraph "${BASENAME}_unlifted.txt" &&
...
bedGraphToBigWig temp_lifted_merged.bedGraph "$data_dir/hg38.chrom.sizes" "${BASENAME}_hg38.bw"
